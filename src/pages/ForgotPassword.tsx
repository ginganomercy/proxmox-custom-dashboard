...
export function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(response.data.message || 'If that username exists, a password reset link has been sent.');
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <GlassCard className="w-full max-w-md p-8 relative z-10">
        ...
        <div className="mt-6 text-center">
          <Link to="/login" className="inline-flex items-center text-sm text-slate-500 hover:text-blue-600 transition-colors">
